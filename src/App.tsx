...
const AdminInsurancePage = lazy(() => import('./pages/admin/AdminInsurancePage').then(m => ({ default: m.AdminInsurancePage })));
      ...
      <ThemeProvider>
        <AuthProvider>
          ...
          >
            ...
            <Route path="insurance" element={<Suspense fallback={<div className="flex items-center justify-center h-64"><LoadingSpinner size="lg" /></div>}> <AdminInsurancePage /> </Suspense>} />
