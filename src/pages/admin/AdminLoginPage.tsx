...
export function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#080f24] bg-gradient-to-br from-primary-900 via-primary-800 to-teal-900 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 flex items-center justify-center p-4">
